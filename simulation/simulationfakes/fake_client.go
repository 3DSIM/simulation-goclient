...
type FakeClient struct {
	...
	PatchPartSupportByIDStub        func(supportID int32, patches []*models.PatchDocument) (*models.PartSupport, error)
...
func (fake *FakeClient) PatchPartSupportByID(supportID int32, patches []*models.PatchDocument) (*models.PartSupport, error) {
	var patchesCopy []*models.PatchDocument
	if patches != nil {
		patchesCopy = make([]*models.PatchDocument, len(patches))
		copy(patchesCopy, patches)
	...
	fake.patchPartSupportByIDArgsForCall = append(fake.patchPartSupportByIDArgsForCall, struct {
		supportID int32
		patches   []*models.PatchDocument
	}{supportID, patchesCopy})
	fake.recordInvocation("PatchPartSupportByID", []interface{}{supportID, patchesCopy})
	fake.patchPartSupportByIDMutex.Unlock()
	if fake.PatchPartSupportByIDStub != nil {
		return fake.PatchPartSupportByIDStub(supportID, patches)
	}
	if specificReturn {
		return ret.result1, ret.result2
	}
	return fake.patchPartSupportByIDReturns.result1, fake.patchPartSupportByIDReturns.result2
}
...
func (fake *FakeClient) PatchPartSupportByIDArgsForCall(i int) (int32, []*models.PatchDocument) {
	fake.patchPartSupportByIDMutex.RLock()
	defer fake.patchPartSupportByIDMutex.RUnlock()
	return fake.patchPartSupportByIDArgsForCall[i].supportID, fake.patchPartSupportByIDArgsForCall[i].patches
}
