...
import models "github.com/3dsim/simulation-goclient/models"
...
// MicrostructureSimulation provides a mock function with given fields: simulationID
func (_m *Client) MicrostructureSimulation(simulationID int32) (*models.MicrostructureSimulation, error) {
	ret := _m.Called(simulationID)

	var r0 *models.MicrostructureSimulation
	if rf, ok := ret.Get(0).(func(int32) *models.MicrostructureSimulation); ok {
		r0 = rf(simulationID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*models.MicrostructureSimulation)
		}
	}
...
// PostMicrostructureSimulation provides a mock function with given fields: _a0
func (_m *Client) PostMicrostructureSimulation(_a0 *models.MicrostructureSimulation) (*models.MicrostructureSimulation, error) {
	ret := _m.Called(_a0)

	var r0 *models.MicrostructureSimulation
	if rf, ok := ret.Get(0).(func(*models.MicrostructureSimulation) *models.MicrostructureSimulation); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*models.MicrostructureSimulation)
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(*models.MicrostructureSimulation) error); ok {
		r1 = rf(_a0)
	} else {
		r1 = ret.Error(1)
	}
